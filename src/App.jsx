      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-20 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            PREMIUM INDUSTRIAL <span className="text-orange-500">COATING</span>{" "}
            SOLUTIONS
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-300 max-w-2xl mx-auto">
            Providing durable, high-quality powder coating and paint finishes in
            Ludhiana since 1995.
          </p>
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              href="#contact"
              className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-full font-bold text-lg transition-transform transform hover:scale-105 flex items-center justify-center gap-2"
            >
              Get a Quote <ArrowRight size={20} />
            </a>
            <a
              href="#services"
              className="bg-transparent border-2 border-white hover:bg-white hover:text-gray-900 text-white px-8 py-3 rounded-full font-bold text-lg transition-colors"
            >
              Our Services
            </a>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              We use advanced technology to ensure the perfect finish for every
              metal surface.
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <p className="text-gray-300">
                  <strong className="text-white">Quality Assurance:</strong> We
                  use only premium grade powders and paints from certified
                  suppliers.
                </p>
              </div>
              <div className="flex items-start gap-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-gray-300">
                  <strong className="text-white">Custom Colors:</strong> We can
                  match any RAL color or custom finish you require.
                </p>
              </div>
            </div>
            <div className="mt-8">
